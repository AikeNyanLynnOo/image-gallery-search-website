  ...
  return (
    <div className="sm:min-w-[450px] sm:max-w-[450px] mb-3 mx-auto">
      ...
      <div className="flex justify-center mb-6 leading">
        <button
          ...
          className={`text-lg flex-1 font-medium px-4 py-2 ${
            active === "signup"
              ? "text-gray-800 border-b-2 border-secondaryTeal-100"
              : "text-gray-500"
          }`}
        >
          Sign up
      ...
      <div className="space-y-4">
        ...
        <button className="flex items-center justify-center w-full py-2 px-4 border border-gray-300 rounded-full text-gray-700 hover:bg-gray-50 transition text-xs sm:text-sm">
